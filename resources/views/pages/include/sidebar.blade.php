<aside id="sidebar" class="col-xs-12 col-sm-12 col-md-4">
                                 ...
                                 <a href="{{route('movie',$hot_sidebar->slug)}}" title="{{$hot_sidebar->title}}">
                                    <div class="item-link">
                                       ...
                                       @if($image_check=='https')
                                               <img class="lazy post-thumb" src="{{$hot_sidebar->image}}" alt="{{$hot_sidebar->title}}" title="{{$hot_sidebar->title}}">
            ...
            <aside id="sidebar" class="col-xs-12 col-sm-12 col-md-4">
               <div id="halim_tab_popular_videos-widget-7" class="widget halim_tab_popular_videos-widget">
                  <div class="section-bar clearfix">
                     <div class="section-title">
                        <span>Phim Sắp Công Chiếu</span>
               ...
               <div id="halim_tab_popular_videos-widget-7" class="widget halim_tab_popular_videos-widget">
                  ...
                  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item active">
                      <a class="nav-link filter-sidebar" id="pills-home-tab" data-toggle="pill" href="#ngay" role="tab" aria-controls="pills-home" aria-selected="true">Ngày</a>
                    </li>
                    <li class="nav-item">
